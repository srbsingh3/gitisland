...
class GitHubService: ObservableObject {
    ...
    private func generateMockData(username: String) -> ContributionData {
        ...
        // Last 154 days (22 weeks), fetched on 2026-02-17
        // Total contributions: 1618
        ...
        // Start date: 2025-09-21 (Sunday)
        guard let startDate = dateFormatter.date(from: "2025-09-21") else {
